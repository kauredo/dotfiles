...
Before spawning investigators, list the available MCPs from the session environment. Use the available-tools map when present. Otherwise inspect the `mcps/` directory Claude Code exposes for enabled MCP servers.
