...
Applies whenever you write prose a human will read: marketing copy, landing/content pages, blog posts, READMEs, PR descriptions, release notes, email. Not code comments or commit messages (those have their own conventions).
